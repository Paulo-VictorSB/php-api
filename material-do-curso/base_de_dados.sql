...
-- Dumping database structure for udemy_clientes
CREATE DATABASE IF NOT EXISTS `udemy_clientes` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `udemy_clientes`;

-- Dumping structure for table udemy_clientes.clientes
...
-- Dumping data for table udemy_clientes.clientes: ~200 rows (approximately)
...
-- Dumping structure for table udemy_clientes.users
...
-- Dumping data for table udemy_clientes.users: ~3 rows (approximately)
INSERT INTO `users` (`id_user`, `username`, `passwrd`) VALUES
	(1, 'cliente1', '$2y$10$ZmEpt45zmp.e7qRcDX2jcO/zvH4ji4tjbGKvJpN2R0qMV17PGm/vu'),
	(2, 'cliente2', '$2y$10$hvMMLWWVHffxj9BHIxVMhum80Ecc.2gloxbq1j7zeQEnc.trgAyyC'),
	(3, 'cliente3', '$2y$10$g94zUNQOnUI6DwdePBui3OdlqDhBONd8TLrQhhGjtWHzwt98b2u8i');
